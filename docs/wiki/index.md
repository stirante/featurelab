...
| [Height Difference Filter Features](./height-difference-filter-feature.md) | Gates delegation on the terrain height difference across a search radius around the origin. New in **1.26.40**, not in this version, and unchanged since. *Not yet categorized by wiki.bedrock.dev.* |
